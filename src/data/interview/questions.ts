    ...
    questions: [
      ...
      },
      {
        ...
        points: [
          ...
          '⭐ The firm also works on PMGSY — the Pradhan Mantri Gram Sadak Yojana, the Ministry of Rural Development\'s rural roads scheme. Say this early: it means your employer is a delivery partner for a centrally-sponsored government scheme, not merely a private firm.',
      ...
      },
      {
        ...
        points: [
          ...
          '⭐ Close the whole thing with the continuity line: "I have worked on three centrally-sponsored schemes in a row — DILRMP, then PMGSY at my current firm, and now I am applying to work on AMRUT, PMAY-U and the Smart City legacy here. It has been the same delivery environment throughout." That single sentence resolves the gap, the private-sector move, and why MUDAL — all at once.',
