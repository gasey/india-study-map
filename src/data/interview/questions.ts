    ...
    questions: [
      ...
      },
      {
        ...
        points: [
          ...
          'The firm also does PMGSY (rural roads) work. ⚠️ That is the FIRM\'s work, not yours — you are in the IT division. Mention it only as context about the employer, and correct anyone who hears it as your experience.',
      ...
      },
      {
        ...
        points: [
          ...
          'Close with the honest continuity line: "I have worked inside a centrally-sponsored digital mission before — DILRMP — and I have stayed in technical work since. This post brings both together." Accurate, and it still resolves the gap and the why-MUDAL question.',
          '⚠️ Do NOT claim your employer\'s PMGSY work as your own. You are in the IT division; the rural roads work is the firm\'s, not yours. An inflated claim that gets probed is far worse than a modest true one.',
